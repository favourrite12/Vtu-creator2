...
<?php 
//print_r($LANG);
  include 'createprocessing.php';
?>

 <title><?php echo $LANG["create_new_admin"];?></title>
              ...
              <div class="divider"></div>
                  ...
                  <div class="col s12 m12 l6">
					...
					<div class="col s12 row">
							...
							<h6><?php echo $LANG["create_new_admin"];?>:</h6>
							<hr color="#fff"/>
							</div>
						...
						<div class="row col-sm-6 ">
							...
							<input type="password" value='<?php echo $confirmPassword;?>' name="confirmPassword" required>
						...
						<div class="col-sm-6">
                                                    <input name="send" <?php if($send==1){echo "checked"; } ?> type="checkbox" value="1" checked id="emailconfig">
						<label  for="emailconfig"><?php echo $LANG["send_this_account_detail_to_the_admin"];?></label>
						</div>
						...
						<div class="col s12 input-field">
							<button class="btn btn-md btn-success right"><?php echo  $LANG["create_new_admin"];?></button>
