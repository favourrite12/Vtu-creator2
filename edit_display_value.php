...
?>
  <?php 
	   ...
	   $sql = "SELECT * FROM display_value WHERE id='$id'";
	  ...
	  ?>
	   ...
	   ?>
 <title>Edit Display Value  - <?php echo $servicePlan['display_name'] ;?></title>
  <section id="content">
         <p id="scroll" class="caption">Edit Display Value - <a class="btn-flat btn-small" href="view.php?id=<?php echo $service?>"><?php echo $serviceName ?></a> - <?php echo $servicePlan['display_name'] ;?> <a href="display_value.php?id=<?php echo $service?>"> <button  class="btn waves-effect waves-light  right" type="submit" >Create New Value <i class="material-icons left">add</i>
                                </button>
								</a>
								</p>
            ...
            <div class="section" >
                  ...
                  <div class="row col s6 m12 l6 custom-form-control ">
                    <div class="card-panel  hoverable ">
                      <div class="row">
                        <form  class="col s12 my12" onsubmit="return ajaxRequest(this,'../../processor/edit_service_display_value.php',getID('scroll'));">
