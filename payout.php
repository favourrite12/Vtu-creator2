 ...
 <?php include '../../admin/include/header.php';?>
  ...
  <title><?php echo $LANG["affiliate_payout_settings"]; ?> - <?php echo $LANG["configuration"]; ?></title>
  <section id="content">
        
        
          <div class="container">
            <div class="section">
              <p class="caption"><?php echo $LANG["affiliate_payout_settings"]; ?> - <?php echo $LANG["configuration"]; ?></p>
...
$sql = "SELECT * FROM web_config WHERE key_group='payout' AND type='textarea' ORDER BY id";
...
$sql = "SELECT * FROM web_config  WHERE  type='checked' AND key_group='payout'";
$result = $conn->query($sql);
