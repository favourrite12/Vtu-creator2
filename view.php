...
<title><?php echo $LANG["transaction_details"]?> - <?php echo $LANG['api_transactions']; ?></title>
...
<div class="col-sm-12 row">
    <div class="left"> <h4><?php echo $LANG['api_transactions']; ?></h4>
        <p><?php echo $LANG["transaction_details"]?></p>
    </div>
 ...
 <?php if(!empty(trim($errorMessage))){ ?>
