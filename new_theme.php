...
function installModule(){
        ...
        var  formData = new FormData(document.getElementById('uploadForm'));
         var d = new Date();
          ...
          xhttp.open("POST", "../../processor/install_theme.php?t="+d.getTime(), true);
          xhttp.send(formData);
 ...
 <title> <?php echo $LANG["install_new_theme"] ?></title>
  <section id="content">
       
          <div class="container">
            <div class="section">
                <p class="caption"> <?php echo $LANG["install_new_theme"] ?> <a target="themesdownload" class="right btn" href="https://provtu.lajela.com/themes"><?php echo $LANG["download_new_theme"];?></a></p>
              <div class="divider"></div>
                <div class="caption alert-danger"><?php echo $LANG["please_only_install_themes_from_lajela_official_site_and_only_source_that_you_trust"];?></div>
...
<div class="row flex-items-sm-center justify-content-center">  
 ...
 <div data-position="left" data-tooltip="<?php echo $LANG["home"] ?>" class=" tooltipped fixed-action-btn">
     <a href="index.php#themes" class="btn-floating btn-large">
