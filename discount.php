 ...
 <?php include '../../admin/include/header.php';?>
  ...
  <title><?php echo $LANG["commission_rate_discount"]; ?> - <?php echo $LANG["configuration"]; ?></title>
  <section id="content">
        
        
          <div class="container">
            <div class="section">
              <p class="caption"><?php echo $LANG["commission_rate_discount"]; ?> - <?php echo $LANG["configuration"]; ?></p>
...
//print_r($adminInfo);
 checkAccess($adminInfo["discount"]);
...
$sql = "SELECT * FROM web_config WHERE  type='checked' AND key_group='discount' ORDER BY key_group";
