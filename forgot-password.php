...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	 $email = mysqli_real_escape_string($conn, $_POST['email']);
		$sql = "SELECT email,user_name,last_update FROM admin  WHERE email = '$email' OR phone = '$email' OR user_name = '$email' OR id = '$email' ";
		...
		$lit = '<a href="//'.$webLink.'/admin/checkpwdrest.php?ut='.$hexe.'&vt='.$hexp.'">
