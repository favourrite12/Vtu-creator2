...
?>
 ...
 <title><?php echo $LANG["create_plan"] ;?>  - <?php echo $serviceValue['display_name'] ;?></title>
  <section id="content">
         <p id="scroll" class="caption"><?php echo $LANG["create_plan"] ;?>  <a class="btn-flat btn-small" href="view.php?id=<?php echo $id; ?>"><?php echo $serviceValue['display_name'] ;?> </a>
		 <a href="setting.php?id=<?php echo "$id&new=$new"?>"> <button  class="btn waves-effect waves-light  right" type="submit" ><?php echo $settingButton ;?>
            ...
            <div class="section" >
                  ...
                  <div class="row col s6 m12 l6 custom-form-control ">
                    <div class="card-panel  hoverable ">
                      <div class="row">
                        <form  class="col s12 my12" onsubmit="return ajaxRequest(this,'../../processor/new_service_plan.php',getID('scroll'));">
						 ...
						 <div class="row">
						  ...
						  <div class="row" >
							<div class="input-field col s12" >
							  <input  id="name" name="price" type="number" value="">
