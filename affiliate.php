 ...
 <?php
   ...
   $sql = "SELECT * FROM web_config WHERE array_key = 'affiliate'";
...
?>
 ...
 <title><?php echo $LANG["affiliate"]; ?> | <?php echo $LANG["configuration"]; ?> </title>

        
        
          <div class="container">
            <div class="section">
              <p class="caption"><?php echo $LANG["configuration"]; ?> | <?php echo $LANG["affiliate"]; ?></p>
