...
function ProgressFunction(event){
			...
			var  formData = new FormData(document.getElementById('uploadForm'));
			  ...
			  xhttp.open("POST", "../../processor/sliderprocessing.php?t="+d.getTime(), true);
			  xhttp.send(formData);
  ...
  <title><?php echo trim($LANG["upload_new_slider"]);?></title>
  ...
  <section id="content">
          ...
          <div class="container flexbox">
            <div class="section" >
              <p class="caption"><?php echo $LANG["upload_new_slider"] ;?></p>
...
<div class="row flex-items-sm-center justify-content-center">  
	...
	<div class="col s12">
	<p class="caption"><?php echo $LANG["upload_new_slider_recommended_size"];?></p>
	</div>
	...
	<div class="col s12">
	   ...
	   <div class="form-group col s12">
		<input type="text" placeholder="<?php echo $LANG["title"];?>" name="title"  id="titleText" class="form-control" />
	   </div>   

	   

	   <div class="form-group col s12">
		<textarea   placeholder="<?php echo $LANG["description"];?>"  name="description"  id="description" class="materialize-textarea" ></textarea>
	   </div>

	  
	   <div class="form-group col-sm-10">
		<input type="number" placeholder="<?php echo $LANG["slider_order_priority"];?>" name="order"  id="priority" class="form-control" />
	   </div>
	  
	   
		<div class=" col-sm-2 pt-sm-4">
